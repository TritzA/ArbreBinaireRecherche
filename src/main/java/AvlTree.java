...
public class AvlTree<ValueType extends Comparable<? super ValueType>> {
    ...
    public void getRootR() {
        if (root.right == null) {
            ...
            System.out.println(root.right.height + " devrait finir a 1 R");
        }
    }

    public void getRootRR() {
        if (root.right.right == null) {
            System.out.println("null");
        } else {
            System.out.println(root.right.right.value + " RR");
        }
    }
    ...
    public void getRootL() {
        if (root.left == null) {
            ...
            System.out.println(root.left.height + "devrait finir a 1 L");
        }
    }
